...
<Aside type="note">
Заголовки с плашкой <Badge text="Remnawave" style="background-color: #f472b6; border-color: #f472b6; color: #000;" /> управляются самой панелью Remnawave автоматически.
